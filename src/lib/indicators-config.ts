...
export const INDICATORS_CONFIG: EconomicIndicator[] = [
  ...
  },
  {
    ...
    description: '供应管理协会制造业采购经理人指数，50为荣枯线，领先指标',
    schedule: '每月第一个工作日',
    importance: 4,
    category: 'pmi_retail',
    fredSeriesId: 'MANEMP',
    unit: '指数',
    marketImpact: {
      beat: 'PMI超预期扩张，制造业复苏，工业股受益，经济扩张信号',
      miss: 'PMI低于50萎缩区间，制造业收缩，衰退担忧加剧',
      inline: 'PMI在荣枯线附近，制造业温和扩张或收缩',
    },
  },
  {
    id: 'ism_services',
    ...
    description: '服务业采购经理人指数，服务业占美国GDP约80%，重要性极高',
    schedule: '每月第三个工作日',
    importance: 4,
    category: 'pmi_retail',
    fredSeriesId: 'NMFCI',
    unit: '指数',
    marketImpact: {
      beat: '服务业扩张强劲，消费和就业支撑有力，经济韧性展现',
      miss: '服务业收缩，对整体经济影响深远，市场风险情绪下降',
      inline: '服务业平稳运行，经济整体维持稳定增长',
    },
  },
  // ===== HOUSING =====
  {
